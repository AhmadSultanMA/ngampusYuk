    ...
    )
    {
        Row(
            ...
            Column {
                ...
                Text(text = "Jadwal SNBP", style = MaterialTheme.typography.labelSmall)
        ...
        Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
            ...
            Image(painter = painterResource(id = R.drawable.snbp_calendar), contentDescription = "calendar", Modifier.size(168.dp))
            Spacer(modifier = Modifier.width(5.dp))
        }
    }
}